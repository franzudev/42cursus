...
void Bureaucrat::executeForm(const Form &form) const{
	if (!form.isSigned())
		std::cout << getName() << " can't exec unsigned form '" << form.getName() << "'" << std::endl;
	else if (getGrade() < form.getExecGrade())
		std::cout << getName() << " executes form '" << form.getName() << "'" << std::endl;
	else
		std::cout << getName() << " can't exec form '" << form.getName() << "', grade is too low" << std::endl;
}
