...
ShrubberyCreationForm::ShrubberyCreationForm(const std::string &target): Form("shrubbery creation", target, 72, 45) {}
...
ShrubberyCreationForm & ShrubberyCreationForm::operator=(
	...
	Form("shrubbery creation", shrubberyCreationForm.getName(), shrubberyCreationForm.getSignGrade(), shrubberyCreationForm.getExecGrade());
